...
public class LayoutTest {
	...
	public LayoutTest() {
		...
		// Layout 화면에 버튼이나 글자를 어디에 놓을지
		// 정하는 규칙!
		JFrame 윈도우창3 = new JFrame();
		
		//화면 설정
		윈도우창3.setSize(400,300);
		//화면 배치도 같이 설정한다.
		// 왼쪽에서 오른쪽으로 정렬
		// 왼쪽부터 차례대로 배치하세요
		// display : flex 와 비슷하다
		// 자바에서도 FlowLayout  가로정렬!
		윈도우창3.setLayout(new FlowLayout());
		...
		윈도우창3.setDefaultCloseOperation(3);

		// 보이기
		윈도우창3.setVisible(true);
