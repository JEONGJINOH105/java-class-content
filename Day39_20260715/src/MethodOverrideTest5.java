...
ArrayList<포켓몬2> 가방 = new ArrayList<>();
}
...
// 카카오페이 결제는 결제다!
class 카카오페이결제2 extends 결제2{
void 결제하기(int 금액) {
System.out.println("카카오결제");
}
}
class 네이버페이 extends 결제2{
void 결제하기(int 금액) {
System.out.println("네이버페이");
}
}
class  카드결제2 extends 결제2{
void 결제하기(int 금액) {
...
ArrayList<결제2> 결제내역 = new ArrayList<>();
