...
public class MapTest {
	...
	// 사용자 대신에 일을 해주는 기능 service 라는 이름이 붙었다.
	...
	public void MapEx() {
		...
		// 자바에서 가장 많이 쓰고있는 key,value 저장방법
	...
	public void 회원정보조회() {
		...
		*/
		...
		boolean 결과2 = 회원응답.containsKey("phone");
		...
		System.out.println("회원정보 개수:"+회원응답.size());
		
		System.out.println("email:"+회원응답.get("email"));
