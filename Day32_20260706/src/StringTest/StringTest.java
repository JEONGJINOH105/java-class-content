...
public class StringTest {
	...
	public static void main(String[] args) {
		...
		// 문자를 자르는 것
		// 문자도 여러개를 저장할때는 배열처럼 한 칸에 하나씩 저장한다.
		...
		// 필요한 정보들을 각각 가져갈 수 있도록 처리할 때
		// substring(시작번호);
		// 시작번호부터 끝까지 알아서 다 짜른다.
...
//		       잘라낸 문자열이 특정 값과 같은지 확인하려면 ==가 아니라 어떤 메서드를 써야 할까요?
		...
		// = 기호를 기준으로 그 뒤에 오는 게시글 번호("1024") 부분만 추출한 뒤, 추출한 값이 "1024"와 일치하면 "해당 게시글입니다",
		// 아니면 "게시글을 찾을 수 없습니다"를 출력하시오.
		// 힌트:
