...
// 혈압이 높으면 추가검사를 해야된다. 알림!
		int[] 혈압 = { 120, 145, 118, 135, 155, 128, 140, 135, 110, 150, 125, 138, 142, 119, 160, 130, 122, 147, 136, 124,
				152, 117, 133, 141, 129, 146, 134, 121, 158, 127, 139, 144, 123, 131, 148, 126, 137, 151, 116, 143 };
		int 번호 = 0;
		if (혈압[번호] >= 140) {
